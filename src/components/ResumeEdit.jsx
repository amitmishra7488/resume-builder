...
const ResumeEdit = () => {
  ...
  const addExperienceField = () => {
    setExperience([...experience, { company: '', yearFrom: null, yearTo: null, designation: '' }]);
  };
  ...
  useEffect(() => {
    if (formData) {
      const { name, email, address, phone, education, experience, skills } = formData;
      setName(name || '');
      setEmail(email || '');
      setAddress(address || '');
      setPhone(phone || '');
              ...
              <div key={index} className='education-item'>
                ...
                <div className='datePicker'>
                  <DatePicker
                    ...
                    onChange={(date) => handleEducationChange(index, 'yearFrom', date)}
                    dateFormat='yyyy'
                    showYearPicker
              ...
              <Form.Group className='field-container'>
                ...
                <div className='skills-container'>
                  {skills.map((skill, index) => (
                    <Badge key={index} pill variant='primary' bg="secondary" className='skill-badge'>
                      {skill.toUpperCase()}
